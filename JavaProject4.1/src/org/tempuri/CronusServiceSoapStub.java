 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {empID});
  ...
  throw axisFaultException;
    ...
    public void insertEmployee(java.lang.String empID, java.lang.String firstName, java.lang.String lastName) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/InsertEmployee");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "InsertEmployee"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {empID, firstName, lastName});
